...
const createProject = (projectName, options) => {
  ...
  Log.i(`using ${chalk.whiteBright.bold(goVersion)} to create workspace`)
  ...
  Log.i(`project ${chalk.whiteBright.bold(projectName)} created successfully.`)
  Log.i(`script to start:`)
  const start_script = chalk.whiteBright(`code ${cwd}/${projectName}`)
  console.log()
